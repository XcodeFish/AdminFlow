<template>
  <div class="logger-api-container">
    <!-- 搜索区域 -->
...
import useApiLogTable from './hooks/useApiLogTable'
import useApiLogActions from './hooks/useApiLogActions'
...
const {
  ...
  handleCleanAll,
  handleExport
} = useApiLogActions(fetchLogList)

// 选中的行
const selectedRows = ref<ApiLog[]>([])
...
// 搜索处理
const handleSearch = (params: ApiLogQueryParams) => {
  // 合并查询参数
